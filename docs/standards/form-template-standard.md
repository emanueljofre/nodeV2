...
| 12  | `script-orphan-assignment`     | Script assignments must reference existing controls     | error    | Template-level                    | [script-hygiene.js](../../tools/review/rules/script-hygiene.js)           |
...
| 16  | `script-field-reference`       | Script field references must exist in template          | error    | Template-level                    | [script-hygiene.js](../../tools/review/rules/script-hygiene.js)           |
...
| 18  | `orphan-group-member`          | Group FieldMember must reference a valid field          | error    | Template-level                    | [orphan-refs.js](../../tools/review/rules/orphan-refs.js)                 |
...
| 26  | `field-multiple-groups`        | Fields must not appear in more than one group           | error    | Template-level                    | [group-checks.js](../../tools/review/rules/group-checks.js)               |
...
| 33  | `admin-override-security`      | Admin Override must have VaultAccess-only visibility    | error    | Template-level                    | [admin-override.js](../../tools/review/rules/admin-override.js)           |
