...
| Rule | Field | Page | Message |
| :--- | :---- | :--- | :------ |
| title-case | How is the Seed Block Marked | Page 1 | Field name "How is the Seed Block Marked" is not in Title Case |
...
| valid-identifier | Region: | Page 1 | Field name "Region:" contains invalid identifier characters |
| accessibility-label | Seed Source Harvest Date | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Question ID | Page 1 | Missing AccessibilityLabel |
...
| script-empty-body | CheckIfDocumentsUploaded | — | Script "CheckIfDocumentsUploaded" has an empty body |
...
| script-empty-body | TriggerParentFormValidation | — | Script "TriggerParentFormValidation" has an empty body |
...
| script-empty-body | UploadAlternativePlanModal | — | Script "UploadAlternativePlanModal" has an empty body |
...
| container-responsive-flow | Con_WesternQ5Body | Page 1 | Container has 2 fields but ResponsiveFlow is not set to 1 Column or 2 Columns (current: 1) |
...
| label-overlap | Region Zone | Page 1 | Label "DataField12" overlaps field by 20px |
| button-min-size | btnHelp | Page 1 | Button is 20x20px — minimum is 24x24px (508 compliance) |
| button-min-size | btnSave | Page 1 | Button is 0x28px — minimum is 24x24px (508 compliance) |
| accessibility-label-match | Retained Acres of Seed Block | Page 1 | AccessibilityLabel "Retained Acres of Seed Block" does not match expected "a. How many acres of the seed block will be retained?" |
| accessibility-label-match | btnHelp | Page 1 | AccessibilityLabel "Help Button" does not match expected "?" |
| accessibility-label-match | Average Seed Trees After Harvest | Page 1 | AccessibilityLabel "Average Seed Trees After Harvest" does not match expected "b. What is the average number of seed trees per acre that will remain after harvest?" |
| accessibility-label-match | Average Seed Tree Age | Page 1 | AccessibilityLabel "Average Seed Tree Age" does not match expected "ii. What is the average age of the seed trees?" |
| accessibility-label-match | Average Seed Tree Height | Page 1 | AccessibilityLabel "Average Seed Tree Height" does not match expected "iii. What is the average height of the seed trees?" |
...
| accessibility-label-match | Sensitive Upload Metadata | Page 1 | AccessibilityLabel "Sensitive Upload Metadata:" does not match expected "Sensitive Upload Metadata" |
...
| Rule | Field | Page | Message |
| :--- | :---- | :--- | :------ |
| group-override-condition | EW Questions | — | Group does not reference an override field in its conditions |
...
| group-override-condition | WW Questions | — | Group does not reference an override field in its conditions |
...
| label-unnamed-in-group | Region: | Page 1 | Label has a custom name but is not referenced in any group — only rename labels used in groups/conditions |
...
| field-max-length | Harvest Scheduled Date | Page 1 | MaxLength is 7 — recommended minimum is 50 |
