...
Generated: 2026-04-16 | Rules: 49 | Findings: 37 (11 errors, 14 warnings, 12 info)
...
| accessibility-required | Spoils Area Identifier | Page 1 | Required field AccessibilityLabel "Spoils Area Identifier required field" should end with "field Required" |
| accessibility-required | Amount of Spoils Deposited | Page 1 | Required field AccessibilityLabel "Amount of Spoils Deposited required field" should end with "field Required" |
| distance-to-border | Top Form ID | Page 1 | Field is 10px from the right border (minimum: 30px) |
| accessibility-label-match | Spoils Area Identifier | Page 1 | AccessibilityLabel "Spoils Area Identifier required field" does not match expected "Spoils Area Identifier" |
| accessibility-label-match | Amount of Spoils Deposited | Page 1 | AccessibilityLabel "Amount of Spoils Deposited required field" does not match expected "Amount of Spoils Deposited" |
...
| label-truncation | Label34 | Page 1 | Label text "Spoils Area Identifier:<strong style="color:#9E0000;">*</strong>" (~448px) may be truncated in 160px width — increase width or enable wrapping |
| label-truncation | Label35 | Page 1 | Label text "Amount of Spoils Deposited:<strong style="color:#9E0000;">*</strong>" (~476px) may be truncated in 160px width — increase width or enable wrapping |
