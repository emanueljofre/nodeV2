...
| title-case | JSON Add Contact | Page 1 | Field name "JSON Add Contact" is not in Title Case |
| default-name | Image50 | Page 1 | Default field name "Image50" — use a descriptive name |
| accessibility-label | Country | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Zip Code | Page 1 | Missing AccessibilityLabel |
...
| accessibility-label | State | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Province | Page 1 | Missing AccessibilityLabel |
...
| accessibility-label | Legacy Contact ID | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Temp Data Migration ID | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Fill and Relate Form | Page 1 | Missing AccessibilityLabel |
| accessibility-label | JSON Add Contact | Page 1 | Missing AccessibilityLabel |
...
| script-empty-body | AddProponent | — | Script "AddProponent" has an empty body |
...
| script-empty-body | AddTimberOwner | — | Script "AddTimberOwner" has an empty body |
...
| script-empty-body | AddTimberOwnerModal | — | Script "AddTimberOwnerModal" has an empty body |
...
| script-empty-body | AddOperatorModal | — | Script "AddOperatorModal" has an empty body |
...
| script-empty-body | AddLandownerModal | — | Script "AddLandownerModal" has an empty body |
...
| script-empty-body | AddOperator | — | Script "AddOperator" has an empty body |
...
| script-empty-body | AddLandowner | — | Script "AddLandowner" has an empty body |
...
| script-empty-body | AddSurveyor | — | Script "AddSurveyor" has an empty body |
...
| script-empty-body | AddProponentModal | — | Script "AddProponentModal" has an empty body |
...
| script-empty-body | AddSurveyorModal | — | Script "AddSurveyorModal" has an empty body |
...
| label-overlap | Zip Code | Page 1 | Label "Label66" overlaps field by 15px |
| accessibility-label-match | First Name | Page 1 | AccessibilityLabel "First Name required" does not match expected "First Name" |
| accessibility-label-match | Last Name | Page 1 | AccessibilityLabel "Last Name required" does not match expected "Last Name" |
| accessibility-label-match | Phone | Page 1 | AccessibilityLabel "Phone required" does not match expected "Phone" |
...
| Rule | Field | Page | Message |
| :--- | :---- | :--- | :------ |
| group-override-condition | Action Buttons Read Only | — | Group does not reference an override field in its conditions |
...
| group-override-condition | Mailing Address Read Only | — | Group does not reference an override field in its conditions |
| group-override-condition | Read Only Fields | — | Group does not reference an override field in its conditions |
| group-override-condition | Show County | — | Group does not reference an override field in its conditions |
...
| spelling | JSON Add Contact | Page 1 | Possible misspelling: "JSON" (suggestions: JASON, JON, SON) |
...
| listener-disabled | Legacy Contact ID | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
...
| listener-disabled | JSON Add Contact | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| field-max-length | Address Line 1 | Page 1 | MaxLength is 100 for address field — recommended minimum is 300 |
| field-max-length | Address Line 2 | Page 1 | MaxLength is 100 for address field — recommended minimum is 300 |
| field-max-length | Address Line 3 | Page 1 | MaxLength is 100 for address field — recommended minimum is 300 |
