...
| accessibility-label | Business Name | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business ID Number | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business Country | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business Zip Code | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business Address Line 1 | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business Address Line 2 | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business Address Line 3 | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business City | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business County | Page 1 | Missing AccessibilityLabel |
| accessibility-label | Business Phone | Page 1 | Missing AccessibilityLabel |
...
| script-empty-body | EnableOrDisableRecord | — | Script "EnableOrDisableRecord" has an empty body |
...
| script-empty-body | CheckDuplicateBusiness | — | Script "CheckDuplicateBusiness" has an empty body |
...
| script-empty-body | AddressFieldNamesMap | — | Script "AddressFieldNamesMap" has an empty body |
...
| script-empty-body | AddBusinessModal | — | Script "AddBusinessModal" has an empty body |
...
| accessibility-label-match | btnEnabled | Page 1 | AccessibilityLabel "Button: Enabled" does not match expected "Enabled" |
| accessibility-label-match | bntDisabled | Page 1 | AccessibilityLabel "Button: Disabled" does not match expected "Disabled" |
...
| accessibility-label-match | Duplicate | Page 1 | AccessibilityLabel "Duplicate Record" does not match expected "Is a Duplicate?" |
| accessibility-label-match | Role | Page 1 | AccessibilityLabel "Tab Control" does not match expected "Role" |
...
| Rule | Field | Page | Message |
| :--- | :---- | :--- | :------ |
| group-override-condition | County Visibility | — | Group does not reference an override field in its conditions |
| group-override-condition | Details Read Only | — | Group does not reference an override field in its conditions |
| group-override-condition | Disabled Button | — | Group does not reference an override field in its conditions |
| group-override-condition | Enabled Button | — | Group does not reference an override field in its conditions |
...
| group-override-condition | Save Button Read Only | — | Group does not reference an override field in its conditions |
| group-override-condition | Show Province | — | Group does not reference an override field in its conditions |
| group-override-condition | Show State | — | Group does not reference an override field in its conditions |
...
| listener-disabled | Business Name | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business ID Number | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business Country | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business Zip Code | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business Address Line 1 | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business Address Line 2 | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business Address Line 3 | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business City | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
...
| listener-disabled | Province | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business County | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business Phone | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business Email | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
...
| listener-disabled | Role | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
| listener-disabled | Business Province State | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
...
| field-max-length | Business Address Line 1 | Page 1 | MaxLength is 225 for address field — recommended minimum is 300 |
| field-max-length | Business Address Line 2 | Page 1 | MaxLength is 225 for address field — recommended minimum is 300 |
| field-max-length | Business Address Line 3 | Page 1 | MaxLength is 225 for address field — recommended minimum is 300 |
