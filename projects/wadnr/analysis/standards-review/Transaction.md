...
| group-override-condition | HideFromProviders | — | Group does not reference an override field in its conditions |
| group-override-condition | HideSave | — | Group does not reference an override field in its conditions |
...
| field-max-length | Transaction Description | Page 1 | MaxLength is 500 for notes field — recommended minimum is 3000 |
