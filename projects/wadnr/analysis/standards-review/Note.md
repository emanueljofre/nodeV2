...
| script-empty-body | ShowSuccessModal | — | Script "ShowSuccessModal" has an empty body |
...
| script-empty-body | AddNote | — | Script "AddNote" has an empty body |
...
| label-overlap | Related Record ID | Page 1 | Label "Label30" overlaps field by 12px |
...
| group-override-condition | Hide Form Controls | — | Group does not reference an override field in its conditions |
...
| field-max-length | Note Text | Page 1 | TextArea MaxLength is 1000 — recommended minimum is 3000 for notes/text fields |
