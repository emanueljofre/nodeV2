...
Generated: 2026-04-16 | Rules: 49 | Findings: 21 (4 errors, 7 warnings, 10 info)
...
| label-truncation | DataField1 | Page 1 | Label text "Appellant(s):<strong style="color:#9E0000;">*</strong>" (~378px) may be truncated in 92px width — increase width or enable wrapping |
