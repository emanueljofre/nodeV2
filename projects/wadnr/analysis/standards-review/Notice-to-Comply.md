...
| script-orphan-assignment | 39741eac-0e24-4b0f-a5da-ca142f44a999 | — | Script assignment references non-existent control ID: 6e90cd09-418c-db6a-4314-d874825b531e |
...
| container-responsive-flow | Con_HiddenSection | Page 1 | Container has 43 fields but ResponsiveFlow is not set to 1 Column or 2 Columns (current: none) |
...
| accessibility-label-match | Full Name of DNR Compliance Officer | Page 1 | AccessibilityLabel "Offline Initial Form ID" does not match expected "Full Name of DNR CO" |
...
| spelling | Full Name of DNR Compliance Officer | Page 1 | Possible misspelling: "DNR" (suggestions: DVR, DAR, DIR) |
...
| listener-disabled | Full Name of DNR Compliance Officer | Page 1 | EnableQListener is enabled — verify this field requires query string fill-in/relate capability |
