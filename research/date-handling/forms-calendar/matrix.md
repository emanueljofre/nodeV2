...
| 20. Multi-User Concurrency      |   13    |    0    |    0    |   13    |    0    |    0    |   0   |
| **TOTAL**                       | **364** | **113** | **100** | **148** |  **0**  |  **1**  | **2** |
...
| G12b | Cat 20 — Multi-user concurrency + cross-user date drift | 13 PENDING slots. Scaffolded 2026-04-22 after the V2 baseline close-out (user asked: "are there bugs under concurrent users?"). Customer-agnostic — runs anywhere. | **P1**   |
...
| 4-FAR-DD-BRT-reload |  D→D   | BRT | Source GFV: `...T00:00:00.000Z` (fake) | `2026-03-14T21:00:00`    | `2026-03-14T21:00:00.000Z` | `2026-03-14T21:00:00`  | `2026-03-14T21:00:00.000Z` | FAIL   | 2026-04-22 |
...
| ------------------------- | ------------------------------------------ | :--: | :--: | ------------------------------------ | ------------------------------------ | ------ | ---------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| 11-A-save-BRT-load-IST.V2 | Config A (date-only, TZ-aware), V2         | BRT  | IST  | `"2026-03-14T18:30:00.000Z"` (BUG-7) | `"2026-03-14T18:30:00.000Z"` (BUG-7) | PASS   | 2026-04-22 | [run](../../../projects/emanueljofre-vv5dev/testing/date-handling/forms-calendar/runs/cat11-save-BRT-load-IST-vv5dev-2026-04-20.md) |
| 11-B-save-BRT-load-IST.V2 | Config B (date-only + ignoreTZ), V2        | BRT  | IST  | `"2026-03-15T00:00:00.000Z"`         | `"2026-03-15T00:00:00.000Z"`         | PASS   | 2026-04-22 | [run](../../../projects/emanueljofre-vv5dev/testing/date-handling/forms-calendar/runs/cat11-save-BRT-load-IST-vv5dev-2026-04-20.md) |
| 11-C-save-BRT-load-IST.V2 | Config C (DateTime, TZ-aware), V2          | BRT  | IST  | `"2026-03-15T00:00:00.000Z"`         | `"2026-03-15T00:00:00.000Z"`         | PASS   | 2026-04-22 | [run](../../../projects/emanueljofre-vv5dev/testing/date-handling/forms-calendar/runs/cat11-save-BRT-load-IST-vv5dev-2026-04-20.md) |
| 11-D-save-BRT-load-IST.V2 | Config D (DateTime + ignoreTZ), V2         | BRT  | IST  | `"2026-03-15T00:00:00.000Z"`         | `"2026-03-15T00:00:00.000Z"`         | PASS   | 2026-04-22 | [run](../../../projects/emanueljofre-vv5dev/testing/date-handling/forms-calendar/runs/cat11-save-BRT-load-IST-vv5dev-2026-04-20.md) |
| 11-E-save-BRT-load-IST.V2 | Config E (legacy date-only, TZ-aware), V2  | BRT  | IST  | `"2026-03-14T18:30:00.000Z"` (BUG-7) | `"2026-03-14T18:30:00.000Z"` (BUG-7) | PASS   | 2026-04-22 | [run](../../../projects/emanueljofre-vv5dev/testing/date-handling/forms-calendar/runs/cat11-save-BRT-load-IST-vv5dev-2026-04-20.md) |
| 11-F-save-BRT-load-IST.V2 | Config F (legacy date-only + ignoreTZ), V2 | BRT  | IST  | `"2026-03-15T00:00:00.000Z"`         | `"2026-03-15T00:00:00.000Z"`         | PASS   | 2026-04-22 | [run](../../../projects/emanueljofre-vv5dev/testing/date-handling/forms-calendar/runs/cat11-save-BRT-load-IST-vv5dev-2026-04-20.md) |
| 11-G-save-BRT-load-IST.V2 | Config G (legacy DateTime), V2             | BRT  | IST  | `"2026-03-15T00:00:00.000Z"`         | `"2026-03-15T00:00:00.000Z"`         | PASS   | 2026-04-22 | [run](../../../projects/emanueljofre-vv5dev/testing/date-handling/forms-calendar/runs/cat11-save-BRT-load-IST-vv5dev-2026-04-20.md) |
| 11-H-save-BRT-load-IST.V2 | Config H (legacy DateTime + ignoreTZ), V2  | BRT  | IST  | `"2026-03-15T00:00:00.000Z"`         | `"2026-03-15T00:00:00.000Z"`         | PASS   | 2026-04-22 | [run](../../../projects/emanueljofre-vv5dev/testing/date-handling/forms-calendar/runs/cat11-save-BRT-load-IST-vv5dev-2026-04-20.md) |
...
| 13-ws-input             | DB values when date set via web service / scheduled script                     | Same as equivalent Cat 7/10 web-service input results                                                                                              | All 4 configs (A,B,C,D) store `"2026-03-15T00:00:00Z"` identically via postForms; API bypasses Forms getSaveValue() — no C/D divergence                                            | PASS   | 2026-04-22 | [summary](summaries/tc-13-ws-input.md)             |
...
| 13-B-storage            | Raw DB value for Config B vs Config A                                          | Same storage format as Config A (ignoreTZ has no effect on date-only)                                                                              | A = B = `"2026-03-15T00:00:00Z"` (identical via API write path; ignoreTZ no effect on date-only)                                                                                   | PASS   | 2026-04-22 | [summary](summaries/tc-13-B-storage.md)            |
| 13-C-vs-D-storage       | SQL comparison: Config C vs Config D storage for BRT midnight                  | Config C: `"2026-03-15T03:00:00"` (UTC-equiv, prediction corrected from T21:00); Config D: `"2026-03-15T00:00:00"` (local)                         | Browser-saved: C=`T03:00:00.000Z` (real UTC), D=`T00:00:00.000Z` (local); API-written: C=D (uniform). Mixed storage is Forms-only.                                                 | PASS   | 2026-04-22 | [summary](summaries/tc-13-C-vs-D-storage.md)       |
...
| ---------------- | ------------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------- | ------ | ---------- | ------------------------------------------- |
| 15-vv-core       | VV.Form properties                    | formId, V1/V2 flag, method list, property count | formId=undef, V1, **1 method**, no LocalizationResources, 26 props | formId=undef, V1, **4 methods**, LocalizationResources={}, 28 props | PASS   | 2026-04-22 | [summary](summaries/tc-15-vv-core.md)       |
| 15-fieldMaster-D | fieldMaster Config D                  | All 50+ properties                              | mask="", no format/displayFormat                                   | mask="", no format/displayFormat — **IDENTICAL**                    | PASS   | 2026-04-22 | [summary](summaries/tc-15-fieldMaster-D.md) |
| 15-fieldMaster-C | fieldMaster Config C                  | All 50+ properties                              | mask="", no format/displayFormat                                   | mask="", no format/displayFormat — **IDENTICAL**                    | PASS   | 2026-04-22 | [summary](summaries/tc-15-fieldMaster-C.md) |
| 15-kendo-global  | `kendo` global object                 | version, culture, calendar patterns             | **not defined** (same as v2!)                                      | **not defined** — both use module system                            | PASS   | 2026-04-22 | [summary](summaries/tc-15-kendo-global.md)  |
| 15-widget-opts-D | Kendo widget `.options` for Field5    | format, parseFormats, culture                   | **input not found** (same as v2!)                                  | **input not found** — both lack name attr                           | PASS   | 2026-04-22 | [summary](summaries/tc-15-widget-opts-D.md) |
| 15-widget-opts-A | Kendo widget `.options` for Field7    | format, parseFormats, culture                   | **input not found** (same as v2!)                                  | **input not found** — both lack name attr                           | PASS   | 2026-04-22 | [summary](summaries/tc-15-widget-opts-A.md) |
| 15-sfv-widget    | Widget `.value()` after SetFieldValue | Date epoch, toString, toISOString               | VV OK, widget=null (DOM)                                           | VV OK, widget=null — **IDENTICAL**                                  | PASS   | 2026-04-22 | [summary](summaries/tc-15-sfv-widget.md)    |
| 15-mask-scan     | All calendar fields mask properties   | mask, placeholder, format per field             | No masks (all empty, 26 fields)                                    | Field3/4 have mask (WADNR only), rest empty                         | PASS   | 2026-04-22 | [summary](summaries/tc-15-mask-scan.md)     |
...
## 20 — Multi-User Concurrency

Every existing category tests **one user, one session**. Real customers run forms multi-tenant, multi-TZ, multi-session — a helpdesk rep in IST creates a record, a BRT admin reviews it, a UTC0 analyst round-trips it through a workflow. Date bugs compound across users, and the single-user suite will never reveal them. This category probes the concurrency and cross-user axes.

**Environment**: Any customer with the Date Test Harness form (vv5dev/EmanuelJofre, vvdemo/EmanuelJofre, WADNR when granted write access). Customer-agnostic by design — all inputs map through `FIELD_MAP` and `SAVED_RECORDS` so the spec runs wherever the harness form is deployed.
**Method**: Playwright spawns 2+ browser contexts per test, each with its own `timezoneId` and auth state. Tests orchestrate interleaved save/load/round-trip sequences and capture per-context observations. All writes go through the guarded `saveFormOnly` / `saveFormAndReload` chokepoints — no raw save calls. Every test runs on fresh records created inside the test (never mutates pre-saved records).
**Spec**: `cat-20-concurrency.spec.js` (to be created). Will use `browser.newContext({ timezoneId: ... })` multiple times per worker.
**Bugs potentially exercised**: FORM-BUG-5 multi-user compound drift (already partially covered by TC-11-roundtrip-cross), plus **new bugs** in stale-write detection, optimistic-concurrency semantics, and cross-TZ save-without-edit passthrough.

**Shape**: 5 race/stale + 4 pipeline + 2 helpdesk + 2 timing = **13 slots**. Every slot has a V1 and V2 variant via the standard `scope` filter (so each counts once in the matrix, with `.V2` siblings tracked in `test-data.js` during implementation).

| Test ID                           | Group | Scenario                                                                                                                                                                            |   Config(s)   |        Browsers        | Expected baseline (V1)                                                                                             | Probe question                                                                                         | Status  | Run Date | Evidence |
| --------------------------------- | :---: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------: | :--------------------: | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------- | -------- | -------- |
| 20-race-same-tz-BRT               |   A   | Two BRT browsers open the same record; both change Config D; both click Save within 500 ms. Capture both API responses + final DB state via REST.                                   |       D       |       BRT + BRT        | Last-save-wins (no conflict detection)                                                                             | Does VV return 409/412/409, or silently accept both and keep the later write?                          | PENDING | —        | —        |
| 20-race-cross-tz-BRT-IST          |   A   | BRT browser sets `Config D = 03/15 14:30` and IST browser sets `Config D = 03/16 09:00`; both Save simultaneously.                                                                  |       D       |       BRT + IST        | Last-save-wins; stored value + GFV reflect whichever POST arrived second at the server                             | Does save order correlate with tab focus / click timing / browser startup order?                       | PENDING | —        | —        |
| 20-race-cross-tz-IST-UTC0         |   A   | IST browser + UTC0 browser race. Same pattern with Config A (date-only).                                                                                                            |       A       |       IST + UTC0       | Last-save-wins; stored calendar date = whichever user saved last (in their TZ)                                     | For Config A, does the stored UTC-of-local-midnight come from the IST midnight or the UTC0 midnight?   | PENDING | —        | —        |
| 20-stale-write-same-tz            |   A   | User A opens record, edits Config D. User B opens the same record AFTER A's edit but BEFORE A saves. B saves first (e.g., `Config D = 03/10`). A saves (thinking DB still has old). |       D       |       BRT + BRT        | A's save overwrites B's, silently. No "record has been modified" warning.                                          | Does VV track `modifiedOn` and reject stale writes? Or is A's overwrite silent data loss?              | PENDING | —        | —        |
| 20-stale-write-cross-tz           |   A   | Same as above, but A is BRT and B is IST.                                                                                                                                           |       D       |       BRT + IST        | Same: silent overwrite                                                                                             | Is there any cross-TZ interaction with the stale check?                                                | PENDING | —        | —        |
| 20-pipeline-2user-BRT-IST-D       |   B   | A (BRT) saves Config D = `03/15T14:30`. B (IST) opens the saved record, rounds-trips (GFV → SFV with the returned value), then saves.                                               |       D       |      BRT then IST      | V1: drift compounds across users — A's -3h drift + B's +5:30h drift = net +2:30h (confirmed TC-11-roundtrip-cross) | Does the drift rule extend past 2 users? Does V2 neutralize it entirely, or is there a residual bug?   | PENDING | —        | —        |
| 20-pipeline-2user-IST-BRT-D       |   B   | Reverse: A (IST) saves, B (BRT) round-trips + saves.                                                                                                                                |       D       |      IST then BRT      | V1: net -(-3 + 5:30) = -2:30h vs original                                                                          | Are the two directions symmetric? If not, the fix strategy differs.                                    | PENDING | —        | —        |
| 20-pipeline-3user-BRT-IST-UTC0-D  |   B   | 3-user daisy chain: BRT saves → IST round-trips+saves → UTC0 round-trips+saves. Capture final stored value vs original.                                                             |       D       | BRT then IST then UTC0 | V1: -3h + 5:30h + 0h = +2:30h net drift                                                                            | Does drift accumulate linearly across users, or does something saturate? Does V2 stay at 0?            | PENDING | —        | —        |
| 20-pipeline-2user-B-date-only     |   B   | Same as 2-user pipeline but on Config B (`ignoreTimezone=true`, date-only). B should be immune to FORM-BUG-5.                                                                       |       B       |      BRT then IST      | V1: FORM-BUG-7 fires on IST write (stores Mar 14), but no per-trip drift                                           | Does Config B's ignoreTZ=true actually protect against cross-user date shift under real concurrency?   | PENDING | —        | —        |
| 20-helpdesk-A-IST-set-BRT-review  |   C   | IST user sets Config A (date-only) = today's IST date and saves. BRT admin opens the record, edits an UNRELATED text field, saves without touching Config A.                        | A + textField |      IST then BRT      | V1: FORM-BUG-7 on IST save stores Mar 14. BRT admin's save doesn't touch Config A, so the wrong date persists      | Does BRT admin's save re-run the Config A normalization and apply a second shift? Or is it idempotent? | PENDING | —        | —        |
| 20-helpdesk-A-BRT-set-IST-review  |   C   | BRT user sets Config A = today's BRT date. IST admin opens the record, edits unrelated field, saves. BRT→IST cross-TZ reload on a date-only field.                                  | A + textField |      BRT then IST      | V1: Raw preserved, IST admin's save is idempotent if the Config A init path is read-only on reload                 | Does the IST admin's save re-interpret Config A's stored value through FORM-BUG-7 on the IST side?     | PENDING | —        | —        |
| 20-midnight-crossing-current-date |   D   | Load form at UTC wall-clock T-30s before IST midnight. Wait until UTC is T+30s after IST midnight. Save. Reload record. Compare stored "current date" vs save-time IST date.        | currentDate A |      IST (timed)       | Stored value reflects LOAD-time current date, not save-time (VV captures Current Date on form init, not on save)   | If stored value changes between save and load, the write path is re-evaluating Current Date on save.   | PENDING | —        | —        |
| 20-long-session-save              |   D   | Open form in BRT browser, idle 10 min (shorter than 20-min server TZ cache, but enough to hit any short-lived token refresh), edit Config D, save.                                  |       D       |       BRT (idle)       | Save succeeds normally; record has the edited value; no re-auth loop                                               | Does an idle session trigger a silent re-auth that drops the dirty state?                              | PENDING | —        | —        |

> **Method notes**:
>
> - **Tab-vs-context**: Playwright contexts isolate auth and timezone. Tabs within a single context share auth/TZ — useful for same-user concurrency, not for cross-TZ. Race tests use separate contexts.
> - **Timing determinism**: "Simultaneous" saves use `Promise.all([page1.click('Save'), page2.click('Save')])` + a 500 ms window. Not true simultaneity (server-side processing still serializes), but close enough to probe the optimistic-concurrency gate.
> - **REST sanity check**: Every concurrency slot also fetches the final record via REST after the race resolves, so we have a server-side ground truth independent of whatever either browser displays.
> - **Auth separation**: Each context uses the project's own `storageState`. If a customer has per-user auth (multiple accounts for A and B), add those to `.env.json` under `customers.{name}.testUsers` — the spec picks from there.
> - **Cleanup**: Every test creates a fresh record (no pre-saved records). On teardown, leave the record for audit rather than deleting — DELETE is risky and the sandbox environments can be swept by their own retention policies.
>
> **Expected Value approach**: Same as Cat 17 — first-run failures are **data collection**, not regression. Fill in Actual and convert Probe Question to concrete expected value for the second pass.
